...
var Socket = function(sessionid){
  EventEmitter.call(this);
  this.remoteAddress = "192.168.0.255";
  this.sid = sessionid;
}
util.inherits(Socket, EventEmitter);

Socket.prototype.send = function(msg) {
  console.log("socket ",this.sid, " send msg:",msg);
}
...
Socket.prototype.disconnect = function(){
  console.log("socket ",this.sid, " disconnet",)
}
/**
...
var Session = function(sid, frontendId, socket, service) {
  ...
  // private
  this.__socket__ = new Socket(this.id);
